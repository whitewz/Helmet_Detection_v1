...
def detect(save_img=False, annotator=None):
    global  tick
    ...
    weights_dict['model'].names = ['yes', 'no']
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for c in det[:, -1].unique():
                    ...
                    if "Not wearing properly" in names[int(c)]:  # 获得检测结果类名，判断==Not wearing properly
                        if  tick == 0:  # tick记No出现次数
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='weights/wjrsbest.pt', help='model.pt path(s)')
